...
void DEVICE::BLED_set(char data)
{
	if (data & 0x01) {
...
/*****************************************************************************/
	//Speed Control Timer
void DEVICE::control_start(void){gptimer_start(timer0);}
void DEVICE::control_stop(void){gptimer_stop(timer0);}

	//Sensor Control Timer
void DEVICE::sensor_start(void){gptimer_start(timer1);}
void DEVICE::sensor_stop(void){gptimer_stop(timer1);}
