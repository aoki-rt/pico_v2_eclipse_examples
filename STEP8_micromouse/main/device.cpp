...
/*****************************************************************************/
	//Speed Control Timer
void DEVICE::controlStart(void){gptimer_start(timer0);}
void DEVICE::controlStop(void){gptimer_stop(timer0);}

	//Sensor Control Timer
void DEVICE::sensorStart(void){gptimer_start(timer1);}
void DEVICE::sensorStop(void){gptimer_stop(timer1);}
